...
import static com.mycompany.bugtracker.domain.TicketAsserts.*;
import static com.mycompany.bugtracker.web.rest.TestUtil.createUpdateProxyForBean;
...
class TicketResourceIT {
    ...
    void partialUpdateTicketWithPatch() throws Exception {
        ...
        partialUpdatedTicket.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).done(UPDATED_DONE);
