...
describe('Ticket Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, TicketUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Project query and add missing value', () => {
      ...
      const project: IProject = { id: 1474 };
      ticket.project = project;

      const projectCollection: IProject[] = [{ id: 3942 }];
    ...
    it('Should call User query and add missing value', () => {
      const ticket: ITicket = { id: 456 };
      const assignedTo: IUser = { id: 28354 };
      ticket.assignedTo = assignedTo;

      const userCollection: IUser[] = [{ id: 28568 }];
    ...
    it('Should call Label query and add missing value', () => {
      const ticket: ITicket = { id: 456 };
      const labels: ILabel[] = [{ id: 2236 }];
      ticket.labels = labels;

      const labelCollection: ILabel[] = [{ id: 2932 }];
    ...
    it('Should update editForm', () => {
      const ticket: ITicket = { id: 456 };
      const project: IProject = { id: 11653 };
      ticket.project = project;
      const assignedTo: IUser = { id: 29375 };
      ticket.assignedTo = assignedTo;
      const label: ILabel = { id: 8281 };
      ticket.labels = [label];
