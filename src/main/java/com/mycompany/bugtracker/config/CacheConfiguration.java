...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mycompany.bugtracker.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mycompany.bugtracker.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.mycompany.bugtracker.domain.PersistentToken.class.getName());
            createCache(cm, com.mycompany.bugtracker.domain.User.class.getName() + ".persistentTokens");
